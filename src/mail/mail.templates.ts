export function layout(content: string, clientUrl: string): string {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
export function welcomeEmail(name: string, clientUrl: string): string {
  return layout(
    `<h2 style="margin:0 0 16px;font-size:22px;color:#18181b;">Welcome to Eventful!</h2>
     ...
     <p style="margin:0;color:#71717a;">Happy exploring!</p>`,
    clientUrl,
  );
}
...
export function ticketConfirmedEmail(
  name: string,
  event: { title: string; date: string; location: string; price: number },
  clientUrl: string,
): string {
  ...
  return layout(
    `<h2 style="margin:0 0 16px;font-size:22px;color:#18181b;">Ticket Confirmed!</h2>
     <p style="margin:0 0 12px;color:#52525b;line-height:1.6;">Hi ${name.toUpperCase()},</p>
...
export function paymentReceiptEmail(
  ...
  return layout(
    `<h2 style="margin:0 0 16px;font-size:22px;color:#18181b;">Payment Receipt</h2>
...
export function eventReminderEmail(
  ...
  return layout(
    `<h2 style="margin:0 0 16px;font-size:22px;color:#18181b;">Event Reminder</h2>
     <p style="margin:0 0 12px;color:#52525b;line-height:1.6;">Hi ${name},</p>
...
export function domainTestEmail(name: string, clientUrl: string): string {
  return layout(
    `<h2 style="margin:0 0 16px;font-size:22px;color:#18181b;">Custom domain test</h2>
     <p style="margin:0 0 12px;color:#52525b;line-height:1.6;">Hi ${name},</p>
