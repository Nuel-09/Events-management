...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Emmanuel Dennis' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'New password (min 6 chars). Google-only accounts can set a password without currentPassword.',
        minLength: 6,
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
